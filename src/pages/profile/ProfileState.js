...
export const SELECT_MODEL_TYPE = "Profile/SELECT_MODEL_TYPE";
export const CREATE_MODEL_PENDING = "Profile/CREATE_MODEL_PENDING";
export const CREATE_MODEL_SUCCESS = "Profile/CREATE_MODEL_SUCCESS";
export const CREATE_MODEL_ERROR = "Profile/CREATE_MODEL_ERROR";
export const SELECT_DATA_REQUIREMENTS_FEATURES_LIST = "Profile/SELECT_DATA_REQUIREMENTS_FEATURES_LIST";
export const SELECT_DATA_REQUIREMENTS_FEATURES_RANGE = "Profile/SELECT_DATA_REQUIREMENTS_FEATURES_RANGE";
export const SELECT_DATA_REQUIREMENTS_FEATURES_PRE_PROCESSING = "Profile/SELECT_DATA_REQUIREMENTS_FEATURES_PRE_PROCESSING";
export const SELECT_DATA_REQUIREMENTS_FEATURES_DESC = "Profile/SELECT_DATA_REQUIREMENTS_FEATURES_DESC";
export const SELECT_DATA_REQUIREMENTS_TARGET_RANGE = "Profile/SELECT_DATA_REQUIREMENTS_TARGET_RANGE";
export const SELECT_DATA_REQUIREMENTS_TARGET_DESC = "Profile/SELECT_DATA_REQUIREMENTS_TARGET_DESC";
export const LOAD_FILE = "Profile/LOAD_FILE";
export const LOAD_FILE_NAME = "Profile/LOAD_FILE_NAME";
export const SELECT_TOTAL_PAY = "Profile/SELECT_TOTAL_PAY";
export const SELECT_MODEL_NAME = "Profile/SELECT_MODEL_NAME";
